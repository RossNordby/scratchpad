...
//                {
//                    var clothNodeBody = simulation.Bodies.GetBodyReference(clothNodeHandle);
...
//        dancers = new DemoDancers().Initialize<ClothCallbacks, ClothCollisionFilter>(40, 40, Simulation, collisionFilters, ThreadDispatcher, BufferPool, (1, 4), TailorDress, new ClothCollisionFilter(0, 0, -1));
