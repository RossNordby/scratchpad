...
public class City : Scene
{
    ...
    public override void Initialize(Random random, int threadCount)
    {
        ...
        Simulation = Simulation.Create(BufferPool, new NarrowPhaseCallbacks() { SpringSettings = new SpringSettings(30, 1) }, new DemoPoseIntegratorCallbacks(Gravity), new SubsteppingTimestepper(1), 8);
        ...
        var plankDescription = BodyDescription.CreateDynamic(new Vector3(), plankInertia, new(Simulation.Shapes.Add(plankShape), 0.1f), new (0.01f));
        ...
        var floorDescription = BodyDescription.CreateDynamic(new Vector3(), floorInertia, new(Simulation.Shapes.Add(floorShape), 0.1f), new (0.01f));
        ...
        Simulation.Statics.Add(new StaticDescription(new Vector3(0, -5, 0), new (Simulation.Shapes.Add(new Box(3500, 10, 3500)), 0.1f)));
    }
