    ...
    partial class Tree
    {
        ...
        public unsafe void SweepRefine(int nodeIndex, ref QuickList<int> spareNodes, out bool nodesInvalidated)
        {
            ...
            if (newTreeletCost < originalTreeletCost)
            {
                ...
                ReifyStagingNodes(nodeIndex, stagingNodes, ref subtreeReferences, ref treeletInternalNodes, ref nextInternalNodeIndexToUse, ref spareNodes, out nodesInvalidated);
