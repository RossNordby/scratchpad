...
namespace SolverPrototype.Constraints
{
    ...
    public struct ContactManifold4Constraint : IConstraintDescription<ContactManifold4Constraint, ContactManifold4TypeBatch>
    {
        ...
        public void FillDescription(ContactManifold4TypeBatch batch, int bundleIndex, int innerIndex)
        {
            ref var lane = ref GatherScatter.Get(ref batch.PrestepData[bundleIndex].Normal.X, innerIndex);
            Normal.X = lane;
            Normal.Y = Unsafe.Add(ref lane, Vector<float>.Count);
            Normal.Z = Unsafe.Add(ref lane, 2 * Vector<float>.Count);

            Contact0.OffsetA.X = Unsafe.Add(ref lane, 3 * Vector<float>.Count);
            Contact0.OffsetA.Y = Unsafe.Add(ref lane, 4 * Vector<float>.Count);
            Contact0.OffsetA.Z = Unsafe.Add(ref lane, 5 * Vector<float>.Count);
            Contact0.OffsetB.X = Unsafe.Add(ref lane, 6 * Vector<float>.Count);
            Contact0.OffsetB.Y = Unsafe.Add(ref lane, 7 * Vector<float>.Count);
            Contact0.OffsetB.Z = Unsafe.Add(ref lane, 8 * Vector<float>.Count);
            Contact0.PenetrationDepth = Unsafe.Add(ref lane, 9 * Vector<float>.Count);
            Contact1.OffsetA.X = Unsafe.Add(ref lane, 10 * Vector<float>.Count);
            Contact1.OffsetA.Y = Unsafe.Add(ref lane, 11 * Vector<float>.Count);
            Contact1.OffsetA.Z = Unsafe.Add(ref lane, 12 * Vector<float>.Count);
            Contact1.OffsetB.X = Unsafe.Add(ref lane, 13 * Vector<float>.Count);
            Contact1.OffsetB.Y = Unsafe.Add(ref lane, 14 * Vector<float>.Count);
            Contact1.OffsetB.Z = Unsafe.Add(ref lane, 15 * Vector<float>.Count);
            Contact1.PenetrationDepth = Unsafe.Add(ref lane, 16 * Vector<float>.Count);
            Contact2.OffsetA.X = Unsafe.Add(ref lane, 17 * Vector<float>.Count);
            Contact2.OffsetA.Y = Unsafe.Add(ref lane, 18 * Vector<float>.Count);
            Contact2.OffsetA.Z = Unsafe.Add(ref lane, 19 * Vector<float>.Count);
            Contact2.OffsetB.X = Unsafe.Add(ref lane, 20 * Vector<float>.Count);
            Contact2.OffsetB.Y = Unsafe.Add(ref lane, 21 * Vector<float>.Count);
            Contact2.OffsetB.Z = Unsafe.Add(ref lane, 22 * Vector<float>.Count);
            Contact2.PenetrationDepth = Unsafe.Add(ref lane, 23 * Vector<float>.Count);
            Contact3.OffsetA.X = Unsafe.Add(ref lane, 24 * Vector<float>.Count);
            Contact3.OffsetA.Y = Unsafe.Add(ref lane, 25 * Vector<float>.Count);
            Contact3.OffsetA.Z = Unsafe.Add(ref lane, 26 * Vector<float>.Count);
            Contact3.OffsetB.X = Unsafe.Add(ref lane, 27 * Vector<float>.Count);
            Contact3.OffsetB.Z = Unsafe.Add(ref lane, 29 * Vector<float>.Count);
            Contact3.OffsetB.Y = Unsafe.Add(ref lane, 28 * Vector<float>.Count);
            Contact3.PenetrationDepth = Unsafe.Add(ref lane, 30 * Vector<float>.Count);

            SpringSettings.NaturalFrequency = Unsafe.Add(ref lane, 31 * Vector<float>.Count);
            SpringSettings.DampingRatio = Unsafe.Add(ref lane, 32 * Vector<float>.Count);
            SpringSettings.MaximumRecoveryVelocity = Unsafe.Add(ref lane, 33 * Vector<float>.Count);

            TangentX.X = Unsafe.Add(ref lane, 34 * Vector<float>.Count);
            TangentX.Y = Unsafe.Add(ref lane, 35 * Vector<float>.Count);
            TangentX.Z = Unsafe.Add(ref lane, 36 * Vector<float>.Count);

            TangentY.X = Unsafe.Add(ref lane, 37 * Vector<float>.Count);
            TangentY.Y = Unsafe.Add(ref lane, 38 * Vector<float>.Count);
            TangentY.Z = Unsafe.Add(ref lane, 39 * Vector<float>.Count);

            FrictionCoefficient = Unsafe.Add(ref lane, 40 * Vector<float>.Count);
        }
    }
}
