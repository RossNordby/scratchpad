...
namespace SolverPrototype.Constraints
{
    ...
    public struct ContactManifold1OneBodyPrestepData
    {
    ...
    public struct ContactManifold1OneBodyProjection
    {
        ...
        public ContactPenetrationLimit1OneBody.Projection Penetration;
    }

    public struct ContactManifold1OneBodyFunctions :
        IOneBodyConstraintFunctions<ContactManifold1OneBodyPrestepData, ContactManifold1OneBodyProjection, ContactManifold1AccumulatedImpulses>
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Prestep(Bodies bodies, ref Vector<int> bodyReferences, int count,
            float dt, float inverseDt, ref ContactManifold1OneBodyPrestepData prestep, out ContactManifold1OneBodyProjection projection)
        {
            ...
            ContactPenetrationLimit1OneBody.Prestep(ref projection.InertiaA, ref prestep.Normal, ref prestep, dt, inverseDt, out projection.Penetration);
        }
        ...
        public void WarmStart(ref BodyVelocities wsvA, ref ContactManifold1OneBodyProjection projection, ref ContactManifold1AccumulatedImpulses accumulatedImpulses)
        {
            ...
            ContactPenetrationLimit1OneBody.WarmStart(ref projection.Penetration, ref projection.InertiaA,
        ...
        public void Solve(ref BodyVelocities wsvA, ref ContactManifold1OneBodyProjection projection, ref ContactManifold1AccumulatedImpulses accumulatedImpulses)
        {
            ...
            ContactPenetrationLimit1OneBody.Solve(ref projection.Penetration, ref projection.InertiaA, ref projection.Normal,
                ref accumulatedImpulses.Penetration0, ref wsvA);
        }
    ...
    /// </summary>
    public class ContactManifold1OneBodyTypeBatch :
        OneBodyTypeBatch<ContactManifold1OneBodyPrestepData, ContactManifold1OneBodyProjection, ContactManifold1AccumulatedImpulses, ContactManifold1OneBodyFunctions>
    {
