...
namespace SolverPrototype.Constraints
{
    ...
    public static class TangentFrictionCompressed
    {
        ...
        public static void ComputeJacobians(ref Vector3Wide normal, ref Vector3Wide tangentX, ref Vector3Wide offsetA, ref Vector3Wide offsetB,
            out Jacobians jacobians)
        {
            ...
            Vector3Wide.CrossWithoutOverlap(ref normal, ref tangentX, out jacobians.LinearA.Y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Prestep(ref Vector3Wide normal, ref Vector3Wide tangentX, ref Vector3Wide offsetA, ref Vector3Wide offsetB,
            ref BodyInertias inertiaA, ref BodyInertias inertiaB,
            out TangentFrictionProjectionCompressed projection)
        {
            ComputeJacobians(ref normal, ref tangentX, ref offsetA, ref offsetB, out var jacobians);
